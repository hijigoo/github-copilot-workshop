...
![Plan 도구 활성화](../screenshot/step08-plan-tool-enable.png)
...
![Start Implementation 버튼](../screenshot/step08-start-implementation.png)
...
/clear
```
![/clear 명령](../screenshot/step08-clear-command.png)
