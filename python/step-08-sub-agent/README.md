...
Step 7에서 `@reviewer`, `@builder`, `@refactor` 같은 Custom Agent를 **개별로** 호출했습니다.
...
> Step 7에서 만든 Agent의 `description`이 명확할수록 자동 위임이 정확해집니다.
...
>
> ![Sub-Agent 활성화](../screenshot/step08-enable-subagent.png)
...
![Sub-Agent 자동 위임](../screenshot/step08-enable-subagent.png)
